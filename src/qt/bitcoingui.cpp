    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("PePeCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About PePeCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about PePeCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for PePeCoin Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the PePeCoin Core help message to get a list with possible PePeCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("PePeCoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("PePeCoin Core"); // default title
