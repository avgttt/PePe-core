    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("PePeCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About PePeCoin Core"));
...
All the PePeCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 PEPE, 0.1 PEPE, 1 PEPE and 10 PEPE -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("PePeCoin Core is shutting down...") + "<br /><br />" +
