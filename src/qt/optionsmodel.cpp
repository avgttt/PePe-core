...
void OptionsModel::Init(bool resetSettings)
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::PEPE);
    ...
    if (!settings.contains("nPrivateSendAmount")) {
        ...
        if (!settings.contains("nAnonymizePePeCoinAmount"))
            ...
            settings.setValue("nPrivateSendAmount", settings.value("nAnonymizePePeCoinAmount").toInt());
    }
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in PePeCoin.cpp during shotdown to also remove the window positions
