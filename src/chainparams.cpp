...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1683637200, 1374688, 0x1e0fffff, 1, 50 * COIN);
//        MineGenesis(genesis,consensus.powLimit,false);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x00000003e537087aa080e8f659a731006e2d2d4bf35999ed3a05166145e1c630"));
        assert(genesis.hashMerkleRoot == uint256S("0xe0028eb9648db56b1ac77cf090b99048a8007e2bb64b68f092c03c7f56a662c7"));

//        vSeeds.push_back(CDNSSeedData("PePeCoin.org", "118.24.26.125"));
//        vSeeds.push_back(CDNSSeedData("PePeCoindot.io", "112.73.84.138"));
//        vSeeds.push_back(CDNSSeedData("masternode.io", "112.73.84.184"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0x00000003e537087aa080e8f659a731006e2d2d4bf35999ed3a05166145e1c630")),
            1683637200, // * UNIX timestamp of last checkpoint block
