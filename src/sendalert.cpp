...
2. run PePeCoind with -printalert or -sendalert like this:
   /path/to/PePeCoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.PePeCoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/PePeCoin Core:0.12.0.58/"));
